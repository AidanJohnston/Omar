...
public class DataPopulate {
    ...
    private static void popAppointment() {
        ...
        list.add(new Appointment(new DataReader().readPatients().get(1), new DataReader().readDoctors().get(1), LocalDate.of(2018, 12, 2), new Diagnosis("Sick", new Date(2018, 12, 2), "You are sick"), new Prescription("Drug", new Date(2018, 12, 2), "Cures being sick", "Take once an hour")));
