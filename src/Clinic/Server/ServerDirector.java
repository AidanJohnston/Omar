...
public class ServerDirector {
    ...
    public Object createAppointment(Object params) throws IncorrectPayloadException {
        ...
        app.setID((list.stream().mapToInt(d -> d.getID()).max()).getAsInt() + 1);
        list.add(app);
    ...
    public Object createDoctor(Object params) throws IncorrectPayloadException {
        ...
        try {
            ...
            doc.setID((list.stream().mapToInt(d -> d.getID()).max()).getAsInt() + 1);
            list.add(doc);
    ...
    public Object createPatient(Object params) throws IncorrectPayloadException {
        ...
        try {
            ...
            pat.setID((list.stream().mapToInt(d -> d.getID()).max()).getAsInt() + 1);
            list.add(pat);
    ...
    public Object createStaff(Object params) throws IncorrectPayloadException {
        ...
        try {
            ...
            sta.setID((list.stream().mapToInt(d -> d.getID()).max()).getAsInt() + 1);
            list.add(sta);
    ...
    public Object createAccount(Object params) throws IncorrectPayloadException {
        ArrayList<Patient> list = new DataReader().readPatients();
        ArrayList<Credentials> credList = new DataReader().readCredentials();
        try {
            Object[] objs = (Object[]) params;
            ...
            try {
                ...
                //If this happens something TERRIBLY WRONG has happened
                e.printStackTrace();
                System.out.println("Yo run data populate again");
                return new ServerException("Login failed after creating new account");
            }
        }catch(NullPointerException e){
            throw new IncorrectPayloadException("Invalid payload");
        }
