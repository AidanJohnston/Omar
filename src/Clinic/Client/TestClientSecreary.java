...
public class TestClientSecreary {
    ...
    public void setupLogger() {
        logger = Logger.getLogger(TestClientSecreary.class.getName());
        logger.setLevel(Level.INFO);
    }

    @Test
    public void testLogin() throws ServerException {
        Assert.assertThat(token.getType(), is(UserType.STAFF));
    }
    ...
    public void test_GetAllAppointment() throws ServerException {
        ...
        list.add(new Appointment(new DataReader().readPatients().get(0),
                new DataReader().readDoctors().get(0),
                LocalDate.of(2020, 12, 2),
                "05:02",
                new Diagnosis(),
                new Prescription()));
        list.add(new Appointment(new DataReader().readPatients().get(1),
        ...
        Assert.assertEquals(appointmentArrayList.toString(), list.toString());
    ...
    public void TestgetAppointmentsDoctorAll() throws ServerException {
        ...
        list.add(new Appointment(new DataReader().readPatients().get(1),
                ...
                new Diagnosis("Sick",
                        LocalDate.of(2018, 12, 2),
                        "You are sick"), new Prescription("Drug",
                LocalDate.of(2018, 12, 2),
                "Cures being sick",
                "Take once an hour")));
    ...
    public void TestgetDoctorAll() throws ServerException {
        ...
        Assert.assertEquals(list.toString(), appointmentArrayList.toString());
        System.out.println("Test passed!\n");
    }
    ...
    public void TestgetDoctorWithID() throws ServerException {
        ...
        Assert.assertEquals(doctor.toString(), appointmentArrayList.toString());
        System.out.println("Test passed!\n");
    }
    ...
    public void TestgetPatientAll() throws ServerException {
        ...
        ArrayList<Patient> appointmentArrayList = clientSecretary.getPatientAll(token);

        ArrayList<Patient> list = new ArrayList<>();

        list.add(new Patient("Dawson",
                "Aevo",
                LocalDate.of(2000, 3, 26 ),
                696969,
                "420 oh heck yeah Street",
                14, "80-7259803",
                2525,
                LocalDate.of(2020, 1, 12),
                "ON"));
        list.add(new Patient("Aidan",
                "Johnston",
                LocalDate.of(1999, 5, 25),
                2525,
                "Hey there this is an adress",
                52352,
                "607-2343",
                242,
